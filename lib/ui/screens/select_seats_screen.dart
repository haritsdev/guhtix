...
class SelectSeatScreen extends StatefulWidget {
  final Ticket ticket;
  const SelectSeatScreen({Key? key, required this.ticket}) : super(key: key);
    ...
    return WillPopScope(
        onWillPop: () async {
          context.read<PageBloc>().add(
              GoToSelectScheduleScreen(movieDetail: widget.ticket.movieDetail));
          return false;
        },
        child: Scaffold(
            body: Stack(
                    ...
                    Align(
                      ...
                      child: FloatingActionButton(
                        ...
                        onPressed: selectedSeats.length > 0
                            ? () {
                                print(selectedSeats.length.toString());
                                context.read<PageBloc>().add(GoToCheckoutScreen(
